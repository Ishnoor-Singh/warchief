// Scenario builders for Warchief battles

import { AgentState, TroopAgent, Vec2, Team, TroopStats } from './types';
import { Flowchart, createEngageOnSightFlowchart, createHoldPositionFlowchart } from './flowchart';
